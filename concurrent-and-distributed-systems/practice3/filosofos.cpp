...
void funcion_filosofo_invertido( int id )
{
  int id_ten_izq = (id+1)              % num_filo_ten, //id. tenedor izq.
      id_ten_der = (id+num_filo_ten-1) % num_filo_ten, //id. tenedor der.
      peticion;
...
int main( int argc, char** argv )
{
   ...
   if( num_procesos == num_procesos_actual )
   {
      ...
      if( id_propio == 0 )                              // si es el primer proceso
        funcion_filosofo_invertido( id_propio );        //   es el filosofo que coge los cubiertos en orden inverso
      else if ( id_propio % 2 == 0 && id_propio != 0)   // si es par y no es el primer proceso
        funcion_filosofos( id_propio );                 //   es un filósofo normal
      else                                              // si es impar
