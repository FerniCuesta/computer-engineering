...
/**
  * @brief Función que ajusta el contraste de la imagen
...
/**
  * @brief Función que calcula la media de pixeles de una imagen entera o de un fragmento
  * @param i Fila de la imagen en la que se quiere hacer la media
  * @param j Columna de la imagen en la que se quiere hacer la media
  * @param height Numero de filas en las que se quiere hacer la media
  * @param width Numero de columnas con las que se quiere hacer la media
  * @pre 0 < (i, j, height, width) < tamaño maximo 
  * @return Valor medio de pixeles de la zona elegida
*/

    double Mean (int i, int j, int height, int width) const;

/**
  *@brief Función que genera una subimagen de la imagen original 
  * @param factor Factor de reducción de la imagen original respecto al icono
  * @pre @p factor tiene que ser > 0
  * @return La imagen iconizada
  * @post  La imagen no se modifica
  * @post La imagen resultante tendrá el tamaño int(filas/factor) X int(columnas/factor). Descartando los decimales de la division  
*/

    Image Subsample(int factor) const;
/**
  *@brief Función que recorta un trozo de la imagen
...
/**
  * @brief funcion que se encarga de hacer un zoom x2 a una subimagen
*/
    Image Zoom2X() const;
/**
  *@brief funcion que baraja pseudoaleatoriamente las filas de la imagen  
*/
    void ShuffleRows();
} ;
